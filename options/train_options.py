...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_latest_freq', type=int, default=800, help='frequency of saving the latest results')
        ...
        parser.add_argument('--train_out',type=str, default='train_out',help='store train_out')
        parser.add_argument('--print',type = int,default = 100,help='print console loss')
        self.isTrain = True
        return parser
